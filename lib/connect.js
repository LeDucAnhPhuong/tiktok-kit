...
function connectOfficial({ variant = 'flat' } = {}) {
  ...
  console.log('  2. Approve the project MCP server when Claude Code asks');
  console.log('     (project-scoped servers need approval before first use)');
  console.log('  3. Run  /mcp  → pick "tiktok-ads" → Authenticate');
  console.log('     A browser opens: sign in to TikTok Ads Manager, review the');
  console.log('     permissions, click Authorize. Skipping this leaves the server');
  console.log('     connected but unauthorized, and every plane reads empty.');
  console.log('  4. Run  /tk:connect  to verify data is flowing');
  console.log('');
